    ...
    <div className="p-4 sm:p-6 space-y-5">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <Button
          ...
          disabled={loading}
          className="gap-2 h-8 border-emerald-200 text-emerald-700 hover:bg-emerald-50"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2">
          <Card className="border-emerald-100/80 dark:border-zinc-800">
            <CardHeader className="py-3 px-4 border-b border-zinc-100 dark:border-zinc-800 flex-row items-center justify-between">
              ...
              <Button
                variant="ghost"
                size="sm"
                className="text-[12px] text-emerald-700 gap-1 h-7"
                onClick={() => setView('inquiries')}
              >
                ...
                <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
                  {recent.map((e) => (
                    <button
                      ...
                      className="w-full text-left p-3 hover:bg-emerald-50/40 dark:hover:bg-zinc-800/40 flex gap-3"
                    >
          ...
          {/* Category breakdown */}
          <Card className="border-emerald-100/80 dark:border-zinc-800 mt-4">
                    ...
                    <div key={n.id} className="p-3 flex gap-2.5">
                      <div
                        className={cn(
                          ...
                          n.type === 'warning' ? 'bg-amber-500' : n.type === 'ai' ? 'bg-purple-500' : n.type === 'system' ? 'bg-blue-500' : 'bg-emerald-500'
                        )}
                      />
                ...
                {recentAudit.map((e) => (
                  <div key={e.id} className="p-3">
                    <div className="flex items-center gap-2 mb-0.5">
                      <span className="text-[12px] font-mono text-emerald-700 dark:text-emerald-400">
                        {e.action}
                      </span>
...
function StatCard({
  ...
  return (
    <button
      onClick={onClick}
      className="text-left bg-white dark:bg-zinc-900 border border-emerald-100/80 dark:border-zinc-800 rounded-xl p-4 hover:border-emerald-300 hover:shadow-md hover:shadow-emerald-500/10 transition-all"
    >
...
function QuickAction({
  ...
  return (
    <button
      onClick={onClick}
      className="text-left bg-white dark:bg-zinc-900 border border-emerald-100/80 dark:border-zinc-800 rounded-xl p-3 hover:border-emerald-300 hover:bg-emerald-50/30 transition-all flex items-center gap-2.5"
    >
      <div className="size-8 rounded-md bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shrink-0">
        {icon}
      </div>
      <div className="min-w-0">
